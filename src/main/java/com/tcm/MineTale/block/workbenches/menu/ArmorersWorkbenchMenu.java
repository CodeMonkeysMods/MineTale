...
public class ArmorersWorkbenchMenu extends AbstractWorkbenchContainerMenu {
   ...
   /**
    ...
    /**
     * Populates the given StackedItemContents with items available to the workbench's recipe book.
     *
     * Accounts for item stacks from the player's inventory, from this menu's container slots, and from
     * networked nearby item stacks provided to the client. If nearby items are present on the client,
     * a debug message is printed to standard output.
     *
     * @param contents the target StackedItemContents to populate for recipe-book matching
     */
    @Override

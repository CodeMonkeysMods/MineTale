...
public class BuildersWorkbenchEntity extends AbstractWorkbenchEntity {
    protected final ContainerData data = new ContainerData() {
        /**
         * Retrieve an internal UI data value for the given index.
         *
         * @param index index of the data entry (0–3)
         * @return the integer value for the specified index; currently always `0`
         */
        @Override
        ...
        /**
         * No-op setter: client-side writes are ignored because the workbench is server-authoritative.
         *
         * @param index the data index to ignore
    ...
    /**
     * Initialises a BuildersWorkbenchEntity at the given world position and block state.
     *
     * Sets the initial workbench tier to 1 and enables pulling items from nearby blocks.
     *

...
public class BuildersWorkbenchMenu extends AbstractWorkbenchContainerMenu {
   ...
   /**
    ...
    /**
     * Create a builders workbench menu bound to a player's inventory and an optional block entity.
     *
     ...
     * @param data              container data synchronised between server and client for numeric state
    ...
    /**
     * Populate the given StackedItemContents with item stacks available to the workbench for recipe matching.
     *
     * <p>Accounts stacks from the player's inventory, from the menu's internal container slots, and from
     * any networked nearby items supplied by the client packet.</p>
     *
     * @param contents the StackedItemContents to populate; will include stacks from the player inventory,
     *                 the workbench container slots and any networked nearby item stacks after this call
     */
    @Override
    ...
    /**
     * Provide the recipe input used by this menu's crafting UI.
     *

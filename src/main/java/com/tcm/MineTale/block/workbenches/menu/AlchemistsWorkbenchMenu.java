...
public class AlchemistsWorkbenchMenu extends AbstractWorkbenchContainerMenu {
   ...
   /**
     ...
     */
    public AlchemistsWorkbenchMenu(int syncId, Inventory playerInventory) {
     ...
     *
     * Uses an empty internal container (size 0) and the class's data size for synchronisation of numeric state.
     *
     ...
     */
    public AlchemistsWorkbenchMenu(int syncId, Inventory playerInventory, ContainerData data, @Nullable AbstractWorkbenchEntity blockEntity) {
        // Note: The order of arguments depends on your AbstractWorkbenchContainerMenu,
        // but the 'expectedSize' parameter MUST be 0.
        super(
            ModMenuTypes.ALCHEMISTS_WORKBENCH_MENU,
            syncId, 
    ...
    /**
     * Aggregate item stacks relevant for crafting lookups into the provided StackedItemContents.
     *
     * This includes stacks from the bound player's inventory, any stacks present in this menu's
     * internal container slots, and nearby item stacks supplied by the network when available.
     *
    ...
    /**
     * Provide an empty recipe input for this menu's crafting UI.
     *
     * There are no internal crafting slots for this menu; crafting reads items from the player inventory when triggered.
     *

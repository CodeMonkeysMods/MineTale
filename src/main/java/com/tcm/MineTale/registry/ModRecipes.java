...
public class ModRecipes {
    ...
    /**
     * Register the mod's custom recipe types and their serializers into Minecraft's built-in registries under the mod namespace.
     *
     * Registers the following recipe types with their corresponding serializers: FURNACE_T1_TYPE, CAMPFIRE_TYPE,
     * WORKBENCH_TYPE, ARMORERS_TYPE, FARMERS_TYPE, BUILDERS_TYPE, BLACKSMITHS_TYPE, FURNITURE_TYPE and ALCHEMISTS_TYPE.
     */

...
public class ModRecipes {
    ...
    /**
     * Initialises and registers the mod's custom recipe types and their serializers.
     *
     * Registers the following recipe types and their corresponding serializers into the game's built-in registries:
     * FURNACE_T1_TYPE (furnace), CAMPFIRE_TYPE (campfire), WORKBENCH_TYPE (workbench), ARMORERS_TYPE (armorers),
     * FARMERS_TYPE (farmers) and BUILDERS_TYPE (builders).
     */

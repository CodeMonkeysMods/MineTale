...
public class ModRecipes {
    ...
    /**
     * Register the mod's recipe types and their serializers in Minecraft's built-in registries under the mod namespace.
     *
     * Registers FURNACE_T1_TYPE, CAMPFIRE_TYPE, WORKBENCH_TYPE, ARMORERS_TYPE, FARMERS_TYPE and BUILDERS_TYPE with their

...
import com.tcm.MineTale.block.workbenches.menu.*;
...
public class ModMenuTypes {
    ...
    public static final MenuType<ArmorersWorkbenchMenu> ARMORERS_WORKBENCH_MENU = register(
    ...
    public static final MenuType<BlacksmithsWorkbenchMenu> BLACKSMITHS_WORKBENCH_MENU = register(
    ...
    public static final MenuType<AlchemistsWorkbenchMenu> ALCHEMISTS_WORKBENCH_MENU = register(
            "alchemists_workbench_menu",
            AlchemistsWorkbenchMenu::new
    );

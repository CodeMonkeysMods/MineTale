...
public class FarmerRecipes {
    /**
     * Builds and exports all farm-related workbench recipes used by the data generator.
     *
     * Registers a set of Workbench recipes (inputs, outputs, processing time, unlock criteria and book category)
     * via the supplied exporter; the provider is used to check availability/unlock conditions and the lookup
     * resolves tag-based inputs (for example dirt or logs).
     *
     * @param provider supplies context and availability checks for recipe generation (used for unlock conditions)
     * @param exporter handles writing the generated recipes to the data output
     * @param lookup   resolves holder/tag-based ingredients required by some recipes (for example ItemTags.DIRT)
     */
